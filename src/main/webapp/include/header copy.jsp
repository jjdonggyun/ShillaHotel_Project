...
<div class="header_wrap">
    ...
    <div class="header_nav_01_sub">
        <ul class="w1200">
            ...
            <span></span>
            <li><a href="./ready.jsp">스탠다드</a></li>
            <li><a href="./ready.jsp">이그제큐티브</a></li>
            <li><a href="./ready.jsp">스위트</a></li>
        </ul>
    </div>
    <div class="header_nav_02_sub">
        <ul class="w1200">
            ...
            <span></span>
            <li><a href="./ready.jsp">객실예약</a></li>
            <li><a href="./ready.jsp">다이닝 예약</a></li>
        </ul>
    </div>
    <div class="header_nav_r01_sub">
        <ul class="w1200">
            ...
            <li><a href="#">호텔신라소개</a>
                <div>
                    <p><a class="activated" href="./brand.jsp">개요</a></p>
            ...
            <li><a class="activated" href="./board.jsp">공지사항</a></li>
        </ul>
    </div>
    <div class="header_nav_r02_sub">
        <ul class="w1200">
            ...
            <span></span>
            <li><a href="./ready.jsp">연락처</a></li>
            <li><a href="./ready.jsp">문의하기</a></li>
        </ul>
    </div>
    <div class="header_nav_r03_sub">
        <ul class="w1200">
            ...
            <span></span>
            <li><a href="./ready.jsp">회원특전</a></li>
            <li><a href="./ready.jsp">포인트안내</a></li>
            <li><a href="#">회원전용 프로모션</a>
                <div>
                    <p><a class="activated" href="./promotion.jsp">객실패키지</a></p>
                    <p><a href="./ready.jsp">이벤트</a></p>
                </div>
            </li>
            <li><a href="#">신라리워즈 문의</a>
                <div>
